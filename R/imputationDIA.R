...
#' @param iteration Number of iterations for the imputation. See \code{\link[mice]{mice}} for more details.
#' @param method Method used for the imputation. See \code{\link[mice]{mice}} for more details.
#'
...
imputationDIA <- function(data, transformation = c("none", "log2"),
                          iteration = 3, method = c("norm.predict", "zeros", "pmm", "midastouch",
                                                    ...
                                                    "quadratic", "ri", "2l.norm", "2l.lmer", "2l.pan")
                          ){
