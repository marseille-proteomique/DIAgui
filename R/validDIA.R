...
#'
#' @details If you have replicates or several conditions and you want to see the proportion of non-missing values
...
#'
#' @return ggplot2 graph showing proportion of non-missing values
#'
#' @export

validDIA <- function(data, transformation = c("none", "log2"),
                     tit = "", data_type = c("intensity", "Top3", "iBAQ", "all"),
                     design = NULL, to_check = NULL, prop_cut = 0.75){
  transformation <- match.arg(transformation)
  if(!inherits(prop_cut, c("numeric", "integer"))){
