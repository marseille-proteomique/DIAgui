...
RcppExport SEXP _DIAgui_col_max(SEXP quantitiesSEXP, SEXP mSEXP, SEXP nSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _DIAgui_maxlfq_solve(SEXP quantitiesSEXP, SEXP peptidesSEXP, SEXP samplesSEXP, SEXP marginSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<double>& >::type quantities(quantitiesSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_DIAgui_col_max", (DL_FUNC) &_DIAgui_col_max, 3},
    {"_DIAgui_maxlfq_solve", (DL_FUNC) &_DIAgui_maxlfq_solve, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_DIAgui(DllInfo *dll) {
